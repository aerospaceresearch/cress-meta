...
raspistill -rot 90 -o $FILE_CAPTURE
...
sudo /home/pi/lol_dht22/loldht 7  | $(awk '/Humidity/ { print "PushSensorDHT22 "$7 " " $3 " outside"  }')
sudo /home/pi/lol_dht22/loldht 2  | $(awk '/Humidity/ { print "PushSensorDHT22 "$7 " " $3 " inside" }')
